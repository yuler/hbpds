	...
	<div class="content-wrapper">
	    ...
	    <section class="content">
	      <!-- Main row -->
	     	<div class="row">
	      	  	<div class="box">
	      	  		{!! Form::open(['url' => 'admin/batchDestroy/ads', 'method' => 'delete']) !!}
	      	  		
	                <div class="box-header">
	                  	<h3 class="box-title">专场广告管理</h3>
					  	<br><br>
					  	<div>
			                <a href="/admin/ad/create" class="btn btn-primary btn-xs"><i class="fa fa-plus"></i>  新建</a>
						...
						<table class="table table-bordered table-striped table-hover">
						    ...
						    @foreach ($ads as $ad)
						        <tr>
						            ...
						            <td>{{ $ad->enable }}</td>
						            <td>
						            	<a href="/admin/ad/{{ $ad->id }}/edit" class="btn btn-info btn-xs"><i class="fa fa-edit"></i>  编辑</a>
						            </td>
						        </tr>
							@endforeach 
						    </tbody>
