	    ...
	    <section class="content">
	      <!-- Main row -->
	     	<div class="row">
	                ...
	                <!-- form start -->
	                {!! Form::model($artwork, ['route' => ['admin.artwork.update', $artwork->id ], 'method' => 'put']) !!}
		                ...
		                <div class="box-body">
		                    ...
		                    <div class="form-group">
		                     ...
		                     <div class="form-group">
		                    	...
		                    	{!! Form::text('art_reference', null, ['class' => 'form-control', 'placeholder' => '']) !!}
		                    </div>
		                     <div class="form-group">
		                    	{!! Form::label('art_record', '著录') !!}
		                    	{!! Form::text('art_record', null, ['class' => 'form-control', 'placeholder' => '']) !!}
		                    </div>
		                     <div class="form-group">
		                    	{!! Form::label('art_exhibition', '展览') !!}
		                    	{!! Form::text('art_exhibition', null, ['class' => 'form-control', 'placeholder' => '']) !!}
		                    </div>
		                     <div class="form-group">
