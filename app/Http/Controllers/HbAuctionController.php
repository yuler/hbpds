...
class HbAuctionController extends Controller {
	...
	public function getPreview()
	{
		...
		$asas = HbAsa::where('preview_begin_time', '>' ,[Carbon::now()->year])->where('lang', '=', $lang)->orderBy('preview_begin_time')->paginate(5);
	...
	{	
		...
		$asas = HbAsa::where('preview_begin_time', '<', [Carbon::now()->year])->where('lang', '=', $lang)->orderBy('preview_begin_time','desc')->paginate(5);
